...
var SHA2 = 'SHA2';
var SHA3 = 'SHA3';
exports.TCertEncTCertIndex = "1.2.3.4.5.6.7";
var NonceSize = 24;
var AESKeyLength = 32;
var HMACKeyLength = 32;
var BlockSize = 16;
var GCMTagSize = 16;
var GCMStandardNonceSize = 12;
var ECIESKDFOutput = 512; // bits
var IVLength = 16; // bytes
var AESBlockLength = 16;
var CURVE_P_256_Size = 256;
var CURVE_P_384_Size = 384;
// variables
 ...
 */
var Crypto = (function () {
    function Crypto(hashAlgorithm, securityLevel) {
     ...
     */
    Crypto.prototype.getSecurityLevel = function () {
     ...
     */
    Crypto.prototype.getHashAlgorithm = function () {
    ...
    Crypto.prototype.ecdsaKeyGen = function () {
        return KEYUTIL.generateKeypair("EC", this.curveName);
    };
    ;
    Crypto.prototype.ecdsaKeyFromPrivate = function (key, encoding) {
    ...
    ;
    Crypto.prototype.ecdsaKeyFromPublic = function (key, encoding) {
        var publicKey = new EC(this.ecdsaCurve).keyFromPublic(key, encoding);
        // debug('publicKey: [%j]', publicKey);
        return publicKey;
    };
    ;
    Crypto.prototype.ecdsaSign = function (key, msg) {
    ...
    ;
    Crypto.prototype.ecdsaPEMToPublicKey = function (chainKey) {
    ...
    Crypto.prototype.eciesKeyGen = function () {
        return KEYUTIL.generateKeypair("EC", this.curveName);
    };
    Crypto.prototype.eciesEncryptECDSA = function (ecdsaRecipientPublicKey, msg) {
        var self = this;
        var EC = elliptic.ec;
    ...
    Crypto.prototype.eciesEncrypt = function (recipientPublicKey, msg) {
    ...
    Crypto.prototype.eciesDecrypt = function (recipientPrivateKey, cipherText) {
        var self = this;
    ...
    Crypto.prototype.aesKeyGen = function () {
        return crypto.randomBytes(AESKeyLength);
    };
    Crypto.prototype.aesCFBDecryt = function (key, encryptedBytes) {
        var iv = crypto.randomBytes(IVLength);
    ...
    Crypto.prototype.aesCBCPKCS7Decrypt = function (key, bytes) {
    ...
    ;
    Crypto.prototype.aes256GCMDecrypt = function (key, ct) {
        ...
        var dec = decipher.update(ct.slice(GCMStandardNonceSize, ct.length - GCMTagSize).toString('hex'), 'hex', 'hex');
        dec += decipher.final('hex');
        return dec;
    };
    Crypto.prototype.hkdf = function (ikm, keyBitLength, salt, info) {
        if (!salt)
    ...
    Crypto.prototype.hmac = function (key, bytes) {
        var self = this;
    ...
    Crypto.prototype.hmacAESTruncated = function (key, bytes) {
        var res = this.hmac(key, bytes);
        return res.slice(0, AESKeyLength);
    };
    Crypto.prototype.hash = function (bytes) {
        debug('bytes: ', JSON.stringify(bytes));
     ...
     */
    Crypto.prototype.hkdf2 = function (ikm, keyBitLength, salt, info, Hash) {
    ...
    Crypto.prototype.CBCDecrypt = function (key, bytes) {
    ...
    ;
    Crypto.prototype.PKCS7UnPadding = function (bytes) {
...
exports.Crypto = Crypto; // end Crypto class
...
exports.X509Certificate = X509Certificate; // end X509Certificate class
